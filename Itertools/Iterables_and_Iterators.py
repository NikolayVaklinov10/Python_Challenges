...
lowercase English letters. For a given integer , you can select any
indices (assume
...
space-separated lowercase English letters, denoting the elements of the
 list.
...
Out of these combinations, of them contain either index or index which are
 the indices that contain the letter '
'.
