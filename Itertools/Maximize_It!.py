...
necessarily the largest element. You add the squares of the chosen
elements and perform the modulo operation. The maximum value that you can
...
The next lines each contains an integer , denoting the number of elements
...
Picking
from the st list, from the nd list and from the rd list gives the maximum
 value equal to % = .
